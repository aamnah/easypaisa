      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><textarea name="easypaisa_bank_<?php echo $language['language_id']; ?>" cols="80" rows="10"><?php echo isset(${'easypaisa_bank_' . $language['language_id']}) ? ${'easypaisa_bank_' . $language['language_id']} : ''; ?></textarea>
          ...
          <tr>
            ...
            <td><input type="text" name="easypaisa_total" value="<?php echo $easypaisa_total; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_order_status; ?></td>
            <td><select name="easypaisa_order_status_id">
          ...
          <tr>
            ...
            <td><select name="easypaisa_geo_zone_id">
          ...
          <tr>
            ...
            <td><select name="easypaisa_status">
